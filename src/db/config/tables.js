const createTablesQueries = {
  ...
  createCategories: () => {
    return {
      ...
      text: "CREATE TABLE categories(category_id SERIAL PRIMARY KEY NOT NULL, user_id INT, name TEXT NOT NULL, CONSTRAINT fk_users FOREIGN KEY(user_id) REFERENCES users(user_id) ON DELETE CASCADE)",
    };
  },
  createFinances: () => {
    return {
